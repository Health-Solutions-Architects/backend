...
from sqlalchemy import Column, String, BigInteger, Enum, ForeignKey, DateTime
...
class UsuarioModel(Base):
    ...
    @classmethod
    def create(cls, email: str, senha: str, tipo_usuario: TypeTipoUsuario) -> 'UsuarioModel':
        return UsuarioModel(email=email, senha=senha, tipo_usuario=tipo_usuario)
